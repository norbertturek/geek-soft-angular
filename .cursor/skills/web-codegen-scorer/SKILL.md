...
1. Install globally: `npm install -g web-codegen-scorer`
2. Set API key for the model you'll use:
   ```bash
...
web-codegen-scorer eval --env=angular-example --limit=2
...
Reports are written to a timestamped directory. Open with the built-in viewer or inspect the JSON/HTML output.
